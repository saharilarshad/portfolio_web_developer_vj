...
window.addEventListener("scroll", () => {
  ...
  saluteTextContainer.style.transform = `translateY(${axisY * 0.1}px)`;
  saluteImgContainer.style.transform = `translate(${axisY * 0.4}px ,${
    axisY * 0.7
  }px)`;
  authorName.style.transform = `translateX(${axisY * 0.2}px)`;
  jobTitleContainers[0].style.backgroundPositionY = `${axisY * 0.5}px`;
  jobTitleContainers[1].style.backgroundPositionY = `${-axisY * 0.5}px`;
  jobTitles[0].style.transform = `translateX(calc(200vh - ${axisY}px))`;
  jobTitles[1].style.transform = `translateX(calc(-300vh + ${axisY}px))`;
  projectsTitle.style.transform = `translateY(calc(400vh - ${axisY}px))`;
  //   projectsTitle.style.transform = `translateY(${axisY}px)`;
  phones[0].style.transform = `translateX(calc(500vh - ${axisY}px))`;
  laptop.style.transform = `translateX(calc(600vh - ${axisY}px))`;
  phones[1].style.transform = `translateX(calc(750vh - ${axisY}px))`;
});
